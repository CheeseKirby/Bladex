...
CREATE TABLE IF NOT EXISTS ai_workflow_plan (
    ...
    canonical_contract_json CLOB,
    review_manifest_json CLOB,
    bundle_hash VARCHAR(64),
    bundle_signature VARCHAR(64),
...
CREATE TABLE IF NOT EXISTS ai_workflow_sub_plan (
    ...
    deliverable_ids_json CLOB,
    contract_hash VARCHAR(64),
    referenced_element_ids_json CLOB,
    input_types_json CLOB,
    output_types_json CLOB,
